import { l as t } from "./index-52a1275a.js";
const i = t("productStore", {
  state: () => ({
    promoitem: [
      {
        id: 1,
      ...
      },
      {
        ...
        imagePath: new URL("./assets/Cat-01 1-91f9205f.png", self.location).href,
      },
      {
        id: 3,
        color: "#E7EAF3",
        ...
        imagePath: new URL("./assets/Cms-03 1-a63ae09e.png", self.location).href,
      },
    ],
    catitems: [
      {
    ...
    proditems: [
      {
        id: 1,
        tag: "-17%",
        image: new URL("./assets/p1-2fa2c7c5.jpg", self.location).href,
        category: 1,
      ...
      },
      {
        id: 2,
        tag: "Hot",
        image: new URL("./assets/p2-dc53474c.png", self.location).href,
        category: 3,
      ...
      },
      {
        id: 3,
        tag: "Sale",
        image: new URL("./assets/p3-fb24f717.png", self.location).href,
        category: 3,
      ...
      },
      {
        id: 4,
        tag: "",
        image: new URL("./assets/p4-7b97fe14.png", self.location).href,
        category: 4,
      ...
      },
      {
        id: 5,
        tag: "",
        image: new URL("./assets/p5-0e1526ff.png", self.location).href,
        category: 4,
      ...
      },
      {
        id: 6,
        tag: "",
        image: new URL("./assets/p6-03ff8fee.png", self.location).href,
        category: 2,
      ...
      },
      {
        id: 7,
        tag: "Sale",
        image: new URL("./assets/p7-19265fd6.png", self.location).href,
        category: 2,
      ...
      },
      {
        id: 8,
        tag: "",
        image: new URL("./assets/p8-b92ed42f.png", self.location).href,
        category: 7,
      ...
      },
      {
        id: 9,
        tag: "",
        image: new URL("./assets/p9-71da53f1.png", self.location).href,
        category: 6,
      ...
      },
      {
        id: 10,
        tag: "",
        image: new URL("./assets/p10-d61dccd6.png", self.location).href,
        category: 6,
  ...
  actions: {
    getCat(e) {
      return this.$state.catitems[e];
    },
    getProd(e) {
      return this.$state.proditems[e];
    },
  },
});
export { i as u };
